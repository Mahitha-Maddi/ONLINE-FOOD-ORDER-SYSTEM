...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <br><br> <br><br> 
    <div>
        <h1>Delivery Men Accounts!!</h1>
        <c:set value="${requestScope.deliveryMen}" var="deliveryMen"></c:set>
        <table class="table table-striped table-dark">
                <tr><th>User Id</th><th>FirstName</th><th>LastName</th><th>Phone Number</th><th>Email ID</th><th>Address</th>
                    <th></th></tr>
            <c:forEach items="${deliveryMen}" var="item">
                <tr class="bg-info">
                    ...
                    <td>
                        <form method="post" action="deleteAccounts.htm" >
