...
<%@page import="com.mycompany.dao.MenuItemDao"%>
...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <br><br><br><br>
    <div class="tab">
        <button class="tablinks" onclick="openCity(event, 'Soups')" id="defaultOpen">Soups</button>
        <button class="tablinks" onclick="openCity(event, 'Appetizers')">Appetizers</button>
        <button class="tablinks" onclick="openCity(event, 'Pizzas')">Pizzas</button>
    ...
    <div id="Soups" class="tabcontent">
        <h3>Soups</h3><hr>
        <c:forEach items="${requestScope.soupItemsList}" var="item">
            <c:set var="id" value="${fn:replace(item.itemName, ' ', '')}"/>
            <c:set var="id1" value="#${fn:replace(item.itemName, ' ', '')}"/>
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title" > 
                        <button role="button" data-toggle="modal" data-target="${id1}">
    ...
    <div id="Appetizers" class="tabcontent">
        <h3>Appetizers</h3><hr>
        <c:forEach items="${requestScope.appetizerItemsList}" var="item">
            <c:set var="id" value="${fn:replace(item.itemName, ' ', '')}"/>
            <c:set var="id1" value="#${fn:replace(item.itemName, ' ', '')}"/>
            <div class="card">
                <div class="card-body">
    ...
    <div id="Pizzas" class="tabcontent">
        <h3>Pizzas</h3><hr>
        <c:forEach items="${requestScope.pizzaItemsList}" var="item">
            <c:set var="id" value="${fn:replace(item.itemName, ' ', '')}"/>
            <c:set var="id1" value="#${fn:replace(item.itemName, ' ', '')}"/>
            <div class="card">
                <div class="card-body">
    ...
    <div id="Burgers" class="tabcontent">
        <h3>Burgers</h3><hr>
        <c:forEach items="${requestScope.burgerItemsList}" var="item">
            <c:set var="id" value="${fn:replace(item.itemName, ' ', '')}"/>
            <c:set var="id1" value="#${fn:replace(item.itemName, ' ', '')}"/>
            <div class="card">
                <div class="card-body">
    ...
    <div id="Snacks" class="tabcontent">
        <h3>Snacks</h3><hr>
        <c:forEach items="${requestScope.snackItemsList}" var="item">
            <c:set var="id" value="${fn:replace(item.itemName, ' ', '')}"/>
            <c:set var="id1" value="#${fn:replace(item.itemName, ' ', '')}"/>
            <div class="card">
                <div class="card-body">
    ...
    <div id="Drinks" class="tabcontent">
        <h3>Drinks</h3><hr>
        <c:forEach items="${requestScope.drinkItemsList}" var="item">
            <c:set var="id" value="${fn:replace(item.itemName, ' ', '')}"/>
            <c:set var="id1" value="#${fn:replace(item.itemName, ' ', '')}"/>
            <div class="card">
                <div class="card-body">
    ...
    <div id="Desserts" class="tabcontent">
        <h3>Desserts</h3><hr>
        <c:forEach items="${requestScope.dessertItemsList}" var="item">
            <c:set var="id" value="${fn:replace(item.itemName, ' ', '')}"/>
            <c:set var="id1" value="#${fn:replace(item.itemName, ' ', '')}"/>
            <div class="card">
                <div class="card-body">
