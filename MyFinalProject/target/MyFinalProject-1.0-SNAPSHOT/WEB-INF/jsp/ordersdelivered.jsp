...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <div>
        <c:set var="deliveredOrders" value="${requestScope.deliveredOrders}"></c:set>
        
        <table class="table table-striped table-dark">
            <tr class="bg-info"><th>OrderID</th><th>Order Items</th><th>Customer Name</th><th>Delivery Address</th>
                <th>Order Total Price</th><th>Delivered Date</th><th></th></tr>
         <c:forEach items="${deliveredOrders}" var="item">
                ...
                <tr>
                    ...
                    <td>
                        <c:out value="${item.deliveredDate}"></c:out>
                    </td>
                    <td>
                       Delivered
                    </td>
