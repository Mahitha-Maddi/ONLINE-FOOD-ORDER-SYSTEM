<%-- 
    Document   : login
    Created on : Nov 22, 2020, 12:40:49 AM
    Author     : mahit
--%>
...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <div style="width:1500px; margin:0 auto;">
        <h1>Update Password Below!!</h1>
        <form:form modelAttribute="forgotPassword" method="POST">
            <input type="hidden" name="_token" value="">
            <div class="form-group w-25">
                <label class="control-label">E-Mail Address</label>
                <div>
                    <form:input type="text" name="emailId" path="emailId" class="form-control input-lg" />
            ...
            <div class="form-group w-25">
                ...
                <div>
                    <form:input type="password" class="form-control input-lg" path="password" name="password" />
            ...
            <div class="form-group w-25">
                ...
                <div>
                    <form:input type="password" class="form-control input-lg" path="cpassword" name="cpassword" />
